...
function buildSystemPrompt(todayStr: string, timeStr: string) {
  return `You are Maantis, a scheduling agent. Today is ${todayStr}. The current time right now is ${timeStr} IST (India Standard Time, 24h). Year is ${todayStr.split('-')[0]}.
